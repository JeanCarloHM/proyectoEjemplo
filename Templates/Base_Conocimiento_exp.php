            ...
            function Guardar(f)
			{
               ...
               if(dato1=='' || dato2=='' || dato3=='' || dato4=='')
				...
				else
				{
					...
					{	
                    	f.action="../controlador/generico/guardarBase_exp.php";
                    }
					else {}
				}
            }
      ...
      <table width="1086" border="0">
        <tr>
          ...
          <form id="form1" name="form1" action="" method="post">
            <p align="center">&nbsp;</p>
            <p align="center"><span class="Estilo4">Registrar Base de Conocimiento</span></p>
            <table width="734" border="0" align="center">
              <tr>
                <td width="110" align="left"><div align="left"><span class="Estilo5">Código</span></div></td>
                <td width="191"><?php include("../modelo_clases/IncrementoBaseConocimiento.php"); ?>
                  &nbsp;</td>
