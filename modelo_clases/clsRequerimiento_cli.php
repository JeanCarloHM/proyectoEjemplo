...
class clsRequerimiento_cli
 {
        ...
        public function clsRequerimiento_cli(){}
		...
		header( "Location:../../Templates/Gestionar_Requerimiento_cli.php");
		...
		$query="update requerimiento  set Serial='".$this->Serial."',
