...
class clsRequerimiento_agen
 {
        ...
        public function clsRequerimiento_agen(){}
		...
		header( "Location:../../Templates/Gestionar_Requerimiento_agen.php");
		...
		header( "Location:../../Templates/ConsultarRequerimientoAgente.php");
