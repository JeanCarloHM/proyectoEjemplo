...
class clsBase_exp
 {
		...
		header( "Location:../../Templates/Base_Conocimiento_exp.php");
		...
		Tipo='".$this->Tipo."',Palabra_clave='".$this->Palabra_clave."',
		...
		header( "Location:../../Templates/ConsultarBaseExp.php");
